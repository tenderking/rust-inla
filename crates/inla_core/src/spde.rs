use crate::fmesher::FemBlocks;
use crate::sparse::{CscMatrix, sparse_triplet_to_csc};
use sprs::TriMatI;
...
pub fn spde_precision_csc(
    ...
    let g1 = sparse_triplet_to_csc(&fem.g1);
...
mod tests {
    use super::*;
    use crate::fmesher::{Vertex2, Triangle, build_mesh2d};
